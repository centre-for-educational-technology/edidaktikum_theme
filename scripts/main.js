...
(function ($) {
    ...
    $(win).resize(function () {
        ...
        // Height 100 percent
        if (jQuery('.height_100percent').length > 0) {
        ...
        if (jQuery('.image_video_bg_block').length > 0) {
    ...
    // Accordion & Toggle
    if ($('.accordion-01').length > 0 || $('.module_toggle').length > 0) {
